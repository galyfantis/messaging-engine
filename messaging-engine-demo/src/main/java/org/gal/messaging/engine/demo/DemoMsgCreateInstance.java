...
@JsonSerialize(as = ImmutableDemoMsgCreateInstance.class)
@JsonDeserialize(as = ImmutableDemoMsgCreateInstance.class, builder = ImmutableDemoMsgCreateInstance.Builder.class)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonIgnoreProperties(ignoreUnknown = true)
public interface DemoMsgCreateInstance extends DemoMessage {
	...
	static ImmutableDemoMsgCreateInstance.Builder Builder() {
		return ImmutableDemoMsgCreateInstance.builder();
	}

...
@JsonSerialize(as = ImmutableCountGlobalStateProjection.class)
@JsonDeserialize(as = ImmutableCountGlobalStateProjection.class, builder = ImmutableCountGlobalStateProjection.Builder.class)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonIgnoreProperties(ignoreUnknown = true)
public interface CountGlobalStateProjection extends DemoMessage {
	...
	static CountGlobalStateProjection from(DemoGlobalState state) {
		return ImmutableCountGlobalStateProjection.builder()
				.instances(state.numberOfInstances())
				.participants(state.numberOfParticipants())
				.build();
	}

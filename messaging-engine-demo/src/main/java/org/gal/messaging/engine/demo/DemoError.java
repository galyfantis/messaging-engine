...
@JsonSerialize(as = ImmutableDemoError.class)
@JsonDeserialize(as = ImmutableDemoError.class, builder = ImmutableDemoError.Builder.class)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonIgnoreProperties(ignoreUnknown = true)
public interface DemoError extends DemoMessage, InstanceTrait {
	...
	static ImmutableDemoError.Builder Builder() {
		return ImmutableDemoError.builder();
	}

...
@JsonSerialize(as = ImmutableDemoMsgCreate.class)
@JsonDeserialize(as = ImmutableDemoMsgCreate.class, builder = ImmutableDemoMsgCreate.Builder.class)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
@JsonIgnoreProperties(ignoreUnknown = true)
public interface DemoMsgCreate extends DemoMessage, InstanceTrait {
	...
	static ImmutableDemoMsgCreate.Builder Builder() {
		return ImmutableDemoMsgCreate.builder();
	}

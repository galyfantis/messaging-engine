...
public interface Reducer {
	...
	<M extends Message, S extends InstanceState, G extends GlobalState> Collection<MessageEnvelope> reduce(
			Plugin<M, S, G> plugin, MessageEnvelope messageEnvelope, MessageContext ctx, PluginContext<M> context);
